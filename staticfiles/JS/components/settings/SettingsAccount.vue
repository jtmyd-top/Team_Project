      ...
      <el-form label-position="top">
        <el-form-item label="新邮箱地址">
          <el-input
            ...
            <template #suffix>
              <i v-if="'ok' === 'ok'" class="fas fa-check-circle" style="color: #67C23A;"></i>
              <i v-else-if="'taken' === 'taken'" class="fas fa-times-circle" style="color: #F56C6C;"></i>
              <i v-else-if="'invalid' === 'invalid'" class="fas fa-exclamation-circle" style="color: #E6A23C;"></i>
            </template>
          </el-input>

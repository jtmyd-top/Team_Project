...
import{_ as m}from"./chunks/preload-helper-CYKyUB34.js";document.addEventListener("DOMContentLoaded",async function(){const{convertUbbMarkupInHtml:g,renderCommentUbb:b,hydrateUbbDom:p}=await m(async()=>{const{convertUbbMarkupInHtml:e,renderCommentUbb:t,hydrateUbbDom:a}=await import("./chunks/ubb-DLUgd71s.js");return{convertUbbMarkupInHtml:e,renderCommentUbb:t,hydrateUbbDom:a}},__vite__mapDeps([0,1])),{enhanceCodeBlocks:h}=await m(async()=>{const{enhanceCodeBlocks:e}=await import("./chunks/useCodeEnhancer-D0rmz2rR.js");return{enhanceCodeBlocks:e}},[]),{createPublicNoteComments:C}=await m(async()=>{const{createPublicNoteComments:e}=await import("./chunks/usePublicNoteComments-BLkK8YjE.js");return{createPublicNoteComments:e}},[]),{getCsrfToken:c}=await m(async()=>{const{getCsrfToken:e}=await import("./chunks/csrf-BCH8yQFZ.js");return{getCsrfToken:e}},[]);if(!document.getElementById("pn-author-card-inline-styles")){const e=document.createElement("style");e.id="pn-author-card-inline-styles",e.textContent=`

const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["chunks/ubb-CFZqEp-v.js","chunks/vendor-x7oMVP8t.js","chunks/vue-vendor-BEE0dDzt.js","assets/vendor.css","chunks/usePublicNoteComments-4d6zZXQW.js","chunks/apiError-BVbL-ZBU.js"])))=>i.map(i=>d[i]);
const y="modulepreload",k=function(p){return"/static/dist/"+p},w={},v=function(g,c,b){let u=Promise.resolve();if(c&&c.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),e=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));u=Promise.allSettled(c.map(t=>{if(t=k(t),t in w)return;w[t]=!0;const a=t.endsWith(".css"),s=a?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${t}"]${s}`))return;const o=document.createElement("link");if(o.rel=a?"stylesheet":y,a||(o.as="script"),o.crossOrigin="",o.href=t,e&&o.setAttribute("nonce",e),document.head.appendChild(o),a)return new Promise((l,h)=>{o.addEventListener("load",l),o.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${t}`)))})}))}function r(n){const e=new Event("vite:preloadError",{cancelable:!0});if(e.payload=n,window.dispatchEvent(e),!e.defaultPrevented)throw n}return u.then(n=>{for(const e of n||[])e.status==="rejected"&&r(e.reason);return g().catch(r)})};document.addEventListener("DOMContentLoaded",async function(){const{convertUbbMarkupInHtml:p,renderCommentUbb:g,hydrateUbbDom:c}=await v(async()=>{const{convertUbbMarkupInHtml:e,renderCommentUbb:t,hydrateUbbDom:a}=await import("./chunks/ubb-CFZqEp-v.js");return{convertUbbMarkupInHtml:e,renderCommentUbb:t,hydrateUbbDom:a}},__vite__mapDeps([0,1,2,3])),{enhanceCodeBlocks:b}=await v(async()=>{const{enhanceCodeBlocks:e}=await import("./chunks/useCodeEnhancer-Btzxm5f_.js");return{enhanceCodeBlocks:e}},[]),{createPublicNoteComments:u}=await v(async()=>{const{createPublicNoteComments:e}=await import("./chunks/usePublicNoteComments-4d6zZXQW.js");return{createPublicNoteComments:e}},__vite__mapDeps([4,5])),{getCsrfToken:r}=await v(async()=>{const{getCsrfToken:e}=await import("./chunks/csrf-BCH8yQFZ.js");return{getCsrfToken:e}},[]);if(!document.getElementById("pn-author-card-inline-styles")){const e=document.createElement("style");e.id="pn-author-card-inline-styles",e.textContent=`
    ...
    `,document.head.appendChild(e)}if(window.GLOBAL_DATA={noteData:null,navigationData:null,isAuthenticated:!1},function(){const e=document.getElementById("navigation-data"),t=document.getElementById("note-data");if(e)try{const a=JSON.parse(e.textContent);window.GLOBAL_DATA.navigationData=a,window.GLOBAL_DATA.isAuthenticated=a.is_authenticated||!1}catch{}if(t)try{window.GLOBAL_DATA.noteData=JSON.parse(t.textContent)}catch{}}(),typeof Vue>"u")return;const n=Vue.createApp({template:`
      <div v-if="note">
        <!-- 顶部导航栏 -->
        <nav class="pn-navbar">
    ...
    `,data(){return{note:null,errorMessage:null,fullContent:"",isLiking:!1,isFollowing:!1,followLoading:!1,followersCount:0,isAuthenticated:!1,readingTime:0,moreNotes:[],activeTocId:"",currentUserInitial:"U",currentPath:window.location.pathname,currentUserId:null,comments:[],commentContent:"",replyContent:"",replyingToId:null,isSubmittingComment:!1,isLoadingComments:!1,totalComments:0,commentsPage:1,commentsPageSize:20,commentsTotalPages:1,hasMoreComments:!1,showMessageModal:!1,messageContent:"",isSendingMessage:!1,messageTarget:{userId:null,username:"",avatar:""},messageContext:"",messageContextLink:"",reportReasons:[{value:"spam",label:"垃圾广告"},{value:"abuse",label:"辱骂骚扰"},{value:"porn",label:"色情低俗"},{value:"scam",label:"诈骗欺诈"},{value:"privacy",label:"侵犯隐私"},{value:"illegal",label:"违法违规"},{value:"other",label:"其他"}],reportDialog:{visible:!1,submitting:!1,type:"note",targetId:null,targetName:"",context:"",reason:"spam",detail:""},deleteConfirm:{visible:!1,deleting:!1,commentId:null,kind:"comment",replyCount:0,preview:""},userCard:{visible:!1,userId:null,username:"",avatar:"",commentId:null},userCardClickPos:{x:0,y:0},authorCard:{visible:!1,username:"",avatar:"",bio:"",notes_count:0,views_count:0,likes_count:0,loading:!1}}},computed:{displayContent(){return this.fullContent?this.fixImageUrls(p(this.fullContent)):""},isOwnNote(){return!this.note||!this.currentUserId?!1:this.note.author.id===this.currentUserId},userCardPosition(){return{}}},mounted(){this.initializeData(),this.setupScrollListener()},updated(){this.hydrateRuntimeWidgets()},methods:{_publicNoteComments:null,initializeData(){const e=window.GLOBAL_DATA;if(!e||!e.noteData){this.errorMessage="无法获取页面数据";return}this.note=e.noteData,this.isAuthenticated=e.isAuthenticated,this.totalComments=this.note.comment_count||0;const t=document.querySelector('meta[name="user-id"]');t&&t.content&&(this.currentUserId=parseInt(t.content));const a=document.querySelector('meta[name="username"]');a&&(this.currentUserInitial=a.content.charAt(0).toUpperCase()),e.navigationData&&(this.moreNotes=(e.navigationData.navigation_list||[]).filter(o=>o.public_id!==this.note.public_id).slice(0,5));const s=document.getElementById("full-content-data");if(s)try{this.fullContent=JSON.parse(s.textContent)}catch{this.fullContent=this.note.content||""}else this.fullContent=this.note.content||"";if(!this.fullContent){this.errorMessage="无法加载文章内容";return}this.readingTime=Math.max(1,Math.ceil(this.fullContent.replace(/<[^>]+>/g,"").length/400)),this.fetchFollowStatus(),this.$nextTick(()=>{this.hydrateRuntimeWidgets(),this.fetchComments()})},async fetchComments(e=!0){return this._publicNoteComments.fetchComments(this,e)},async loadMoreComments(){return this._publicNoteComments.loadMoreComments(this)},async submitComment(){return this._publicNoteComments.submitComment(this)},async submitReply(e){return this._publicNoteComments.submitReply(this,e)},openDeleteConfirm(e,t=null){return this._publicNoteComments.openDeleteConfirm(this,e,t)},closeDeleteConfirm(){return this._publicNoteComments.closeDeleteConfirm(this)},async confirmDeleteComment(){return this._publicNoteComments.confirmDeleteComment(this)},startReply(e){return this._publicNoteComments.startReply(this,e)},cancelReply(){return this._publicNoteComments.cancelReply(this)},decorateComment(e){return this._publicNoteComments.decorateComment(e)},async reportNote(){if(!this.isAuthenticated){window.location.href="/login/?next="+encodeURIComponent(window.location.pathname);return}!this.note||this.isOwnNote||this.openReportDialog({type:"note",targetId:this.note.id,targetName:this.note.title||"这篇文章",context:this.note.author&&this.note.author.username?`作者：${this.note.author.username}`:""})},async reportComment(e){if(!this.isAuthenticated){window.location.href="/login/?next="+encodeURIComponent(window.location.pathname);return}!e||e.is_owner||e.author_id===this.currentUserId||this.openReportDialog({type:"comment",targetId:e.id,targetName:e.author?`${e.author} 的评论`:"这条评论",context:this.getCommentPreview(e.content||"")})},openReportDialog({type:e,targetId:t,targetName:a,context:s=""}){this.closeUserCard(),this.reportDialog={visible:!0,submitting:!1,type:e,targetId:t,targetName:a,context:s,reason:"spam",detail:""}},closeReportDialog(){this.reportDialog.submitting||(this.reportDialog.visible=!1)},async submitReportDialog(){if(this.reportDialog.submitting||!this.reportDialog.targetId)return;const e=this.reportDialog.type==="note"?`/api/notes/${this.reportDialog.targetId}/report/`:`/api/comments/${this.reportDialog.targetId}/report/`;this.reportDialog.submitting=!0;try{const t=await fetch(e,{method:"POST",headers:{"Content-Type":"application/json","X-CSRFToken":r()},body:JSON.stringify({reason:this.reportDialog.reason,detail:this.reportDialog.detail.trim()})}),a=await t.json().catch(()=>({}));t.ok?(this.showToast(a.message||"举报已提交","success"),this.reportDialog.visible=!1):this.showToast(a.message||a.error||"举报失败","error")}catch{this.showToast("网络错误，请稍后重试","error")}finally{this.reportDialog.submitting=!1}},hydrateRuntimeWidgets(){const e=()=>{c(this.$refs.articleContent),c(this.$refs.commentList),this.$refs.articleContent&&b(this.$refs.articleContent),this.$refs.commentList&&b(this.$refs.commentList)};e(),requestAnimationFrame(e),setTimeout(e,0)},getCommentPreview(e){const t=String(e||"").replace(/\[(?:\/)?(?:b|i|u|img|audio|movie|qqmusic|wymusic|url|forecolor|code|text|codo)(?:=[^\]]+)?\]/gi," ").replace(/\[now\]/gi," ").replace(/https?:\/\/\S+/gi," ").replace(/\s+/g," ").trim();return t?t.length>90?t.slice(0,90)+"...":t:/\[(?:img)\]/i.test(e||"")?"这条评论包含图片内容":/\[(?:audio)\]/i.test(e||"")?"这条评论包含音频内容":/\[(?:movie)\]/i.test(e||"")?"这条评论包含视频内容":/\[(?:qqmusic|wymusic)\]/i.test(e||"")?"这条评论包含音乐内容":/\[(?:code)\]/i.test(e||"")?"这条评论包含代码内容":""},scrollToHeading(e){const t=document.getElementById(e);if(!t)return;const a=document.querySelector(".pn-main");if(a&&window.innerWidth>=960){const s=a.getBoundingClientRect(),l=t.getBoundingClientRect().top-s.top+a.scrollTop-20;a.scrollTo({top:l,behavior:"smooth"})}else window.scrollTo({top:t.getBoundingClientRect().top+window.pageYOffset-80,behavior:"smooth"})},async toggleLike(){if(!this.isAuthenticated){window.location.href="/login/?next="+encodeURIComponent(window.location.pathname);return}if(!this.isLiking){this.isLiking=!0;try{const t=await(await fetch("/api/toggle-note-like/",{method:"POST",headers:{"Content-Type":"application/json","X-CSRFToken":r()},body:JSON.stringify({note_id:this.note.id})})).json();t.status==="success"&&(this.note.user_has_liked=t.user_has_liked,this.note.likes=t.total_likes,this.showToast(t.action==="liked"?"点赞成功！":"已取消点赞","success"))}catch{this.showToast("操作失败，请稍后重试","error")}finally{this.isLiking=!1}}},async fetchFollowStatus(){if(!(!this.note||!this.note.author||!this.note.author.id||this.isOwnNote))try{const e=await fetch(`/api/users/${this.note.author.id}/follow-status/`);if(!e.ok)return;const t=await e.json();this.isFollowing=!!t.is_following,this.followersCount=Number(t.followers_count||0)}catch{}},async toggleFollow(){if(!(this.followLoading||this.isOwnNote||!this.note||!this.note.author||!this.note.author.id)){if(!this.isAuthenticated){window.location.href="/login/?next="+encodeURIComponent(window.location.pathname);return}this.followLoading=!0;try{const e=this.isFollowing?"/api/users/unfollow/":"/api/users/follow/",t=await fetch(e,{method:"POST",headers:{"Content-Type":"application/json","X-CSRFToken":r()},body:JSON.stringify({user_id:this.note.author.id})}),a=await t.json();t.ok&&a.status==="success"?(this.isFollowing=!!a.is_following,this.followersCount=Number(a.followers_count||0),this.showToast(this.isFollowing?"关注成功":"已取消关注","success")):this.showToast(a.message||a.error||"关注操作失败","error")}catch{this.showToast("网络错误，请稍后重试","error")}finally{this.followLoading=!1}}},openMessageModal(){this.messageTarget={userId:this.note.author.id,username:this.note.author.username,avatar:this.note.author.avatar_url},this.messageContext="",this.messageContextLink="",this.showMessageModal=!0,this.messageContent=""},openCommentMessage(e){this.closeUserCard(),this.messageTarget={userId:e.author_id,username:e.author,avatar:e.author_avatar},this.messageContext="来自笔记《"+this.note.title+"》下的评论",this.messageContextLink=this.buildCommentLink(e.id),this.showMessageModal=!0,this.messageContent=""},closeMessageModal(){this.showMessageModal=!1,this.messageContent="",this.messageContext="",this.messageContextLink=""},async sendMessage(){if(!(!this.messageContent.trim()||this.isSendingMessage)){this.isSendingMessage=!0;try{let e=this.messageContent.trim();this.messageContext&&(e=(this.messageContextLink?"["+this.sanitizeMarkdownLinkText(this.messageContext)+"]("+this.messageContextLink+")":"【"+this.messageContext+"】")+`

`+e);const t=await fetch("/api/messages/send/",{method:"POST",headers:{"Content-Type":"application/json","X-CSRFToken":r()},body:JSON.stringify({recipient_id:this.messageTarget.userId,content:e})}),a=await t.json();t.ok?(this.showToast("私信已发送！","success"),this.closeMessageModal()):t.status===403?this.showToast(a.message||a.error||"此用户未开启私信功能","warning"):t.status===401?this.showToast("请先登录后再发送私信","warning"):this.showToast(a.message||a.error||"发送失败","error")}catch{this.showToast("网络错误，请稍后重试","error")}finally{this.isSendingMessage=!1}}},showUserCard(e,t){t.author_id&&(this.userCard={visible:!0,userId:t.author_id,username:t.author,avatar:t.author_avatar,commentId:t.id},this.userCardClickPos={x:e.clientX,y:e.clientY})},closeUserCard(){this.userCard.visible=!1},openCardMessage(){this.openCommentMessage({author_id:this.userCard.userId,author:this.userCard.username,author_avatar:this.userCard.avatar,id:this.userCard.commentId})},startReplyToUser(){const e=this.comments.find(t=>t.id===this.userCard.commentId);e&&this.startReply(e),this.closeUserCard()},async openAuthorCard(){if(!(!this.note||!this.note.author)){this.authorCard={visible:!0,username:this.note.author.username||"",avatar:this.note.author.avatar_url||"",bio:"",notes_count:this.note.author.note_count||0,views_count:0,likes_count:0,loading:!0};try{const e=await fetch(`/api/users/${this.note.author.id}/profile/`);if(e.ok){const t=await e.json();this.authorCard.bio=t.bio||"",typeof t.notes_count=="number"&&(this.authorCard.notes_count=t.notes_count),typeof t.views_count=="number"&&(this.authorCard.views_count=t.views_count),typeof t.likes_count=="number"&&(this.authorCard.likes_count=t.likes_count),t.avatar&&!this.authorCard.avatar&&(this.authorCard.avatar=t.avatar)}}catch{}finally{this.authorCard.loading=!1}}},closeAuthorCard(){this.authorCard.visible=!1},messageFromAuthorCard(){this.closeAuthorCard(),this.openMessageModal()},goToAuthorProfile(){this.note&&this.note.author&&this.note.author.id&&(window.location.href=`/user/${this.note.author.id}/`)},getCookie(e){const t=document.cookie.match(new RegExp("(?:^|; )"+e+"=([^;]*)"));return t?decodeURIComponent(t[1]):""},sanitizeMarkdownLinkText(e){return String(e||"").replace(/[\r\n[\]]/g," ")},buildCommentLink(e){if(!e)return"";const t=this.note&&this.note.public_id,a=t?`/notes/public/${t}/`:window.location.pathname;return`${window.location.origin}${a}?comment=${encodeURIComponent(e)}#comment-${encodeURIComponent(e)}`},getLinkedCommentId(){const t=new URLSearchParams(window.location.search).get("comment");if(t)return t;const a=window.location.hash.match(/^#comment-(.+)$/);return a?decodeURIComponent(a[1]):""},scrollToLinkedComment(){const e=this.getLinkedCommentId();if(!e)return;const t=document.getElementById(`comment-${e}`);if(!t)return;const a=document.querySelector(".pn-main");if(a&&window.innerWidth>=960){const s=a.getBoundingClientRect(),l=t.getBoundingClientRect().top-s.top+a.scrollTop-80;a.scrollTo({top:Math.max(0,l),behavior:"smooth"})}else window.scrollTo({top:t.getBoundingClientRect().top+window.pageYOffset-80,behavior:"smooth"});t.classList.remove("pn-comment-jump-highlight"),t.offsetWidth,t.classList.add("pn-comment-jump-highlight"),setTimeout(()=>t.classList.remove("pn-comment-jump-highlight"),2600)},fixImageUrls(e){if(!e)return"";const t=window.location.origin+"/",a=document.createElement("div");return a.innerHTML=e,a.querySelectorAll("img").forEach(s=>{const o=s.getAttribute("src");o&&!o.match(/^https?:\/\//)&&!o.match(/^\/\//)&&s.setAttribute("src",t+o.replace(/^\//,""))}),a.innerHTML},showToast(e,t="success"){const a=document.createElement("div");a.className=`pn-toast ${t}`,a.textContent=e,document.body.appendChild(a),setTimeout(()=>{a.classList.add("fade-out"),setTimeout(()=>a.remove(),300)},2700)},toggleTheme(){const e=document.documentElement.getAttribute("data-theme")||"light";document.documentElement.setAttribute("data-theme",e==="light"?"dark":"light"),localStorage.setItem("theme",e==="light"?"dark":"light")},adjustFontSize(){const e=this.$refs.articleContent;if(!e)return;const t=["font-size-small","font-size-medium","font-size-large"];let a=t.findIndex(s=>e.classList.contains(s));a===-1&&(a=1),e.classList.remove(...t),e.classList.add(t[(a+1)%t.length])},shareArticle(){const e=window.location.href;navigator.share?navigator.share({title:this.note.title,url:e}).catch(()=>this.copyLink(e)):this.copyLink(e)},copyLink(e){if(navigator.clipboard)navigator.clipboard.writeText(e).then(()=>this.showToast("链接已复制","success"));else{const t=document.createElement("textarea");t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),t.remove(),this.showToast("链接已复制","success")}},setupScrollListener(){const e=this.$refs.progressBar,t=this;let a=null,s=null;const o=i=>{if(!t.note||!t.note.toc||!t.note.toc.length)return;const d=t.note.toc.map(f=>document.getElementById(f.id)).filter(Boolean);let m="";for(const f of d)f.getBoundingClientRect().top-i<=90&&(m=f.id);t.activeTocId=m},l=i=>i===window?()=>{if(e){const d=window.pageYOffset,m=document.documentElement.scrollHeight-window.innerHeight;e.style.width=(m>0?d/m*100:0)+"%"}o(0)}:()=>{if(e){const d=i.scrollHeight-i.clientHeight;e.style.width=(d>0?i.scrollTop/d*100:0)+"%"}o(i.getBoundingClientRect().top)},h=()=>{a&&s&&a.removeEventListener("scroll",s);const i=document.querySelector(".pn-main");i&&window.innerWidth>=960&&i.scrollHeight>i.clientHeight?a=i:a=window,s=l(a),a.addEventListener("scroll",s,{passive:!0})};this.$nextTick(h);let C=null;window.addEventListener("resize",()=>{clearTimeout(C),C=setTimeout(h,200)},{passive:!0})}}});n.mixin({beforeCreate(){this.$options.methods&&this.$options.methods.fetchComments&&(this._publicNoteComments=u({getCsrfToken:r,renderCommentUbb:g,hydrateRuntimeWidgets:()=>this.hydrateRuntimeWidgets(),scrollToLinkedComment:()=>this.scrollToLinkedComment(),showToast:(e,t)=>this.showToast(e,t)}))}}),n.config.errorHandler=(e,t,a)=>{},n.mount("#public-note-app")});

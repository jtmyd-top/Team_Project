...
from messaging.models import MessageGroup, MessagePreference
...
def user_public_profile_view(request, user_id):
    ...
    from messaging.models import UserFollow, UserBlocklist
    from messaging.views import _get_avatar_url

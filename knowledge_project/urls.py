...
urlpatterns = [
    ...
    path('api/messages/groups/<int:group_id>/members/<int:user_id>/role/', views.set_group_member_role_api, name='set_group_member_role_api'),
    path('api/messages/groups/<int:group_id>/members/<int:user_id>/mute/', views.mute_group_member_api, name='mute_group_member_api'),
    path('api/messages/groups/<int:group_id>/invites/', views.group_invite_links_api, name='group_invite_links_api'),
    path('api/messages/groups/<int:group_id>/invites/<int:invite_id>/revoke/', views.revoke_group_invite_link_api, name='revoke_group_invite_link_api'),
    path('api/messages/groups/invites/<str:token>/preview/', views.preview_group_invite_api, name='preview_group_invite_api'),
    path('api/messages/groups/invites/<str:token>/join/', views.join_group_by_invite_api, name='join_group_by_invite_api'),
    ...
    path('api/messages/groups/<int:group_id>/messages/<int:message_id>/pin/', views.pin_group_message_api, name='pin_group_message_api'),

...
def _get_settings(user, peer):
    ...
    from messaging.models import ConversationSettings
...
def _today_new_conv_count(user):
    ...
    from messaging.models import NewConversationQuotaLog
...
def _check_send_permissions(sender, recipient):
    from messaging.models import MessagePreference, UserBlocklist, UserFollow
